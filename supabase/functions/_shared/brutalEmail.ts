      ...
      <tr><td style="background:#ffff00;padding:18px 24px;border-bottom:2px solid #fafafa;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td align="right" style="font-family:'JetBrains Mono','Courier New',monospace;font-size:11px;color:#0a0a0a;text-transform:uppercase;letter-spacing:0.1em;">${escapeHtml(o.eyebrow ?? "")}</td>
          </tr>
        </table>
      </td></tr>
